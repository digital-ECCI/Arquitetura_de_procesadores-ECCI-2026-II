...
## 1. *FPGA Design Software* - Quartus (Para síntesis en FPGA Max 10)

Quartus es un software de diseño digital e implementación FPGA desarrollado por Intel (anteriormente Altera). Es ampliamente utilizado para la síntesis, implementación y verificación de diseños digitales en FPGAs de la familia Cyclone y Max10.

* [Guía de instalación](/labs/00_lab00/Quartus_installation_guide.md)

* [Tutorial de implementación en la FPGA Max10](/labs/00_lab00/proyectoQuartus.md)
