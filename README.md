...
## Profesor
```
Jhon Alexaner Ramírez Martínez
jramirezma@ecci.edu.co
```

## Descripción 

Este laboratorio está diseñado para brindar los conocimientos y habilidades necesarias para construir un sistema digital encaminado al desarrollo de un procesador, abarcando desde la descripción de hardware empleando lenguajes HDL, su respectiva simulación y la posterior implementación en tarjetas de desarrollo basadas en FPGA.
...
<table>
  ...
  <tr>
    <td>2-3</td>
    <td> Sumador de 1 bit, Sumador/Restador 4 bits</td>
